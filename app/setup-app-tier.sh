...
echo "Downloading and installing Node.js v20..."
# Use the official NodeSource setup script for Node.js 20.x
curl -fsSL https://deb.nodesource.com/setup_20.x | sudo -E bash -
# Now install the newer version of Node.js
...
# Use npm --prefix to explicitly set the installation directory. This is more robust.
sudo -u ${ADMIN_USER} npm install --prefix ${APP_DIR} express mssql cors
